...
#define SHPTIMING
#ifdef SHPTIMING
    real(ESMF_KIND_R8) :: shpt_t0, shpt_alloc
    ...
    elseif (localfileformat == ESMF_FILEFORMAT_SHAPEFILE) then
       ...
       call c_esmc_gdal_shpreadcoords(trim(filename)//C_NULL_CHAR, PetNo, PetCnt, &
            localpoints, totaldims, cx_ptr, cy_ptr, localrc)
       if (ESMF_LogFoundError(localrc, ESMF_ERR_PASSTHRU, &
            ESMF_CONTEXT, rcToReturn=rc)) return
#ifdef SHPTIMING
       ...
       write(*, '(A,I6,A,I10,A)') &
            ...
            localpoints, '  (seconds):'
       write(*, '(A,I6,A,F10.4)') &
            '[SHP_TIMING] PET ', PetNo, '    C_read       = ', shpt_read
       write(*, '(A,I6,A,F10.4)') &
            '[SHP_TIMING] PET ', PetNo, '    alloc+copy   = ', shpt_alloc
       write(*, '(A,I6,A,F10.4)') &
...
!    print *, "here 2", rc, localrc
    ...
    if (localfileformat == ESMF_FILEFORMAT_SHAPEFILE) then
       ...
       shpt_total = shpt_read + shpt_alloc &
